...
# TEMPORARILY DISABLED: matching claims the car and sets SafetyModel.byd,
# which the interim vendor firmware cannot serve (its fallback kills CAN RX).
# Restore once our own panda firmware with the byd safety mode is flashed.
FINGERPRINTS = {
